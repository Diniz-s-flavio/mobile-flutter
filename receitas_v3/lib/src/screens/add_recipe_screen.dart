...
class AddRecipeScreen extends StatefulWidget {
  ...
  const AddRecipeScreen({super.key, this.initialCategory});
...
class _AddRecipeScreenState extends State<AddRecipeScreen> {
  ...
  final _imagemController = TextEditingController(text: 'assets/bg.png');
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'Ex.: assets/bg.png (opcional)',
                  border: OutlineInputBorder(),
                ),
              ),
